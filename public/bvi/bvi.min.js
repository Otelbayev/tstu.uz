    ...
    g = {
      "ru-RU": {
        text: {
          ...
          siteColors: "Ð¦Ð²ÐµÑ‚Ð° ÑÐ°Ð¹Ñ‚Ð°",
          images: "Ð˜Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ",
          speech: "Ð¡Ð¸Ð½Ñ‚ÐµÐ· Ñ€ÐµÑ‡Ð¸",
          settings: "ÐÐ°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
          regularVersionOfTheSite: "ÐžÐ±Ñ‹Ñ‡Ð½Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ ÑÐ°Ð¹Ñ‚Ð°",
          letterSpacing: "ÐœÐµÐ¶Ð±ÑƒÐºÐ²ÐµÐ½Ð½Ð¾Ðµ Ñ€Ð°ÑÑÑ‚Ð¾ÑÐ½Ð¸Ðµ",
          normal: "Ð¡Ñ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ð½Ñ‹Ð¹",
          average: "Ð¡Ñ€ÐµÐ´Ð½Ð¸Ð¹",
          big: "Ð‘Ð¾Ð»ÑŒÑˆÐ¾Ð¹",
          lineHeight: "ÐœÐµÐ¶ÑÑ‚Ñ€Ð¾Ñ‡Ð½Ñ‹Ð¹ Ð¸Ð½Ñ‚ÐµÑ€Ð²Ð°Ð»",
          font: "Ð¨Ñ€Ð¸Ñ„Ñ‚",
          arial: "Ð‘ÐµÐ· Ð·Ð°ÑÐµÑ‡ÐµÐº",
          times: "Ð¡ Ð·Ð°ÑÐµÑ‡ÐºÐ°Ð¼Ð¸",
          builtElements:
            "Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ðµ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹ (Ð’Ð¸Ð´ÐµÐ¾, ÐºÐ°Ñ€Ñ‚Ñ‹ Ð¸ Ñ‚Ð´.)",
          on: "Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ",
          off: "Ð’Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ",
          reset: "Ð¡Ð±Ñ€Ð¾ÑÐ¸Ñ‚ÑŒ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸",
          plural_0: "Ð¿Ð¸ÐºÑÐµÐ»ÑŒ",
          plural_1: "Ð¿ÐµÐºÑÐµÐ»Ñ",
          plural_2: "Ð¿Ð¸ÐºÑÐµÐ»ÐµÐ¹",
        },
        voice: {
          fontSizePlus: "Ð Ð°Ð·Ð¼ÐµÑ€ ÑˆÑ€Ð¸Ñ„Ñ‚Ð° ÑƒÐ²ÐµÐ»Ð¸ÌÑ‡ÐµÐ½",
          fontSizeMinus: "Ð Ð°Ð·Ð¼ÐµÑ€ ÑˆÑ€Ð¸Ñ„Ñ‚Ð° ÑƒÐ¼ÐµÌÐ½ÑŒÑˆÐµÐ½",
          siteColorBlackOnWhite:
            "Ð¦Ð²ÐµÑ‚ ÑÐ°Ð¹Ñ‚Ð° Ñ‡ÐµÑ€Ð½Ñ‹Ð¼ Ð¿Ð¾ Ð±ÐµÐ»Ð¾Ð¼Ñƒ",
          siteColorWhiteOnBlack:
            "Ð¦Ð²ÐµÑ‚ ÑÐ°Ð¹Ñ‚Ð° Ð±ÐµÐ»Ñ‹Ð¼ Ð¿Ð¾ Ñ‡ÐµÑ€Ð½Ð¾Ð¼Ñƒ",
          siteColorDarkBlueOnBlue:
            "Ð¦Ð²ÐµÑ‚ ÑÐ°Ð¹Ñ‚Ð° Ñ‚Ñ‘Ð¼Ð½Ð¾-ÑÐ¸Ð½Ð¸Ð¼ Ð¿Ð¾ Ð³Ð¾Ð»ÑƒÐ±Ð¾Ð¼Ñƒ",
          siteColorBeigeBrown:
            "Ð¦Ð²ÐµÑ‚ ÑÐ°Ð¹Ñ‚Ð° ÐºÐ¾Ñ€Ð¸ÌÑ‡Ð½ÐµÐ²Ñ‹Ð¼ Ð¿Ð¾ Ð±ÐµÌÐ¶ÐµÐ²Ð¾Ð¼Ñƒ",
          siteColorGreenOnDarkBrown:
            "Ð¦Ð²ÐµÑ‚ ÑÐ°Ð¹Ñ‚Ð° Ð·ÐµÐ»ÐµÐ½Ñ‹Ð¼ Ð¿Ð¾ Ñ‚Ñ‘Ð¼Ð½Ð¾-ÐºÐ¾Ñ€Ð¸Ñ‡Ð½ÐµÐ²Ð¾Ð¼Ñƒ",
          imagesOn: "Ð˜Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ñ‹",
          imagesOFF: "Ð˜Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ Ð²Ñ‹ÐºÐ»ÑŽÑ‡ÐµÐ½Ñ‹",
          imagesGrayscale: "Ð˜Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ Ñ‡Ñ‘Ñ€Ð½Ð¾-Ð±ÐµÐ»Ñ‹Ðµ",
          speechOn: "Ð¡Ð¸Ð½Ñ‚ÐµÐ· Ñ€ÐµÑ‡Ð¸ Ð²ÐºÐ»ÑŽÑ‡Ñ‘Ð½",
          speechOff: "Ð¡Ð¸Ð½Ñ‚ÐµÐ· Ñ€ÐµÑ‡Ð¸ Ð²Ñ‹ÌÐºÐ»ÑŽÑ‡ÐµÐ½",
          lineHeightNormal:
            "ÐœÐµÐ¶ÑÑ‚Ñ€Ð¾Ñ‡Ð½Ñ‹Ð¹ Ð¸Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ð½Ñ‹Ð¹",
          lineHeightAverage:
            "ÐœÐµÐ¶ÑÑ‚Ñ€Ð¾Ñ‡Ð½Ñ‹Ð¹ Ð¸Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» ÑÑ€ÐµÐ´Ð½Ð¸Ð¹",
          lineHeightBig:
            "ÐœÐµÐ¶ÑÑ‚Ñ€Ð¾Ñ‡Ð½Ñ‹Ð¹ Ð¸Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» Ð±Ð¾Ð»ÑŒÑˆÐ¾Ð¹",
          LetterSpacingNormal:
            "Ð˜Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» Ð¼ÐµÐ¶Ð´Ñƒ Ð±ÑƒÐºÐ²Ð°Ð¼Ð¸ ÑÑ‚Ð°Ð½Ð´Ð°Ñ€Ñ‚Ð½Ñ‹Ð¹",
          LetterSpacingAverage:
            "Ð˜Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» Ð¼ÐµÐ¶Ð´Ñƒ Ð±ÑƒÐºÐ²Ð°Ð¼Ð¸ ÑÑ€ÐµÐ´Ð½Ð¸Ð¹",
          LetterSpacingBig:
            "Ð˜Ð½Ñ‚ÐµÑ€Ð²Ð°Ð» Ð¼ÐµÐ¶Ð´Ñƒ Ð±ÑƒÐºÐ²Ð°Ð¼Ð¸ Ð±Ð¾Ð»ÑŒÑˆÐ¾Ð¹",
          fontArial: "Ð¨Ñ€Ð¸Ñ„Ñ‚ Ð±ÐµÐ· Ð·Ð°ÑÐµÑ‡ÐµÐº",
          fontTimes: "Ð¨Ñ€Ð¸Ñ„Ñ‚ Ñ Ð·Ð°ÑÐµÑ‡ÐºÐ°Ð¼Ð¸",
          builtElementsOn:
            "Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ðµ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹ Ð²ÐºÐ»ÑŽÑ‡ÐµÐ½Ñ‹",
          builtElementsOFF:
            "Ð’ÑÑ‚Ñ€Ð¾ÐµÐ½Ð½Ñ‹Ðµ ÑÐ»ÐµÐ¼ÐµÐ½Ñ‚Ñ‹ Ð²Ñ‹ÐºÐ»ÑŽÑ‡ÐµÐ½Ñ‹",
          resetSettings:
            "Ð£ÑÑ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ñ‹ Ð½Ð°ÑÑ‚Ñ€Ð¾Ð¹ÐºÐ¸ Ð¿Ð¾ ÑƒÐ¼Ð¾Ð»Ñ‡Ð°ÌÐ½Ð¸ÑŽ",
          panelShow: "ÐŸÐ°Ð½ÐµÐ»ÑŒ Ð¾Ñ‚ÐºÑ€Ñ‹Ñ‚Ð°",
          panelHide: "ÐŸÐ°Ð½ÐµÐ»ÑŒ ÑÐºÑ€Ñ‹Ñ‚Ð°",
          panelOn: "Ð’ÐµÑ€ÑÐ¸Ñ ÑÐ°Ð¹Ñ‚Ð° Ð´Ð»Ñ ÑÐ»Ð°Ð±Ð¾Ð²Ð¸ÌÐ´ÑÑ‰Ð¸Ð¹",
          panelOff: "ÐžÐ±Ñ‹Ñ‡Ð½Ð°Ñ Ð²ÐµÑ€ÑÐ¸Ñ ÑÐ°Ð¹Ñ‚Ð°",
        },
      },
      "en-US": {
        text: {
              ...
              var e = function () {
                ...
                i = "\n    <div class='bvi-panel"
                  ...
                  .concat(
                    ...
                    '</div>\n                <a class="bvi-link bvi-fontSize-minus">Ð-</a>\n                <a class="bvi-link bvi-fontSize-plus">Ð+</a>\n            </div>\n            <div class="bvi-block">\n                <div class="bvi-block-title">'
                  )
                  .concat(
                    this._i18n.t("siteColors"),
                    '</div>\n                <a href="#" class="bvi-link bvi-theme-white">Ð¦</a>\n                <a href="#" class="bvi-link bvi-theme-black">Ð¦</a>\n                <a href="#" class="bvi-link bvi-theme-blue">Ð¦</a>\n                <a href="#" class="bvi-link bvi-theme-brown">Ð¦</a>\n                <a href="#" class="bvi-link bvi-theme-green">Ð¦</a>\n            </div>\n            <div class="bvi-block">\n                <div class="bvi-block-title">'
                  )
                  .concat(
                    this._i18n.t("images"),
                  ...
                  .concat(
                    this._i18n.t("settings"),
                    '</div>\n                        <a href="#" class="bvi-link bvi-modal-close" data-bvi="modal-close">Ã—</a>\n                    </div>\n                    <div class="bvi-modal-body">\n                        <div class="bvi-blocks bvi-block-center">\n                            <div class="bvi-block">\n                                <div class="bvi-block-title">'
                  )
                  .concat(
                ...
                (function (e, t, i) {
                  Object.keys(t).forEach(function (i) {
                    ...
                    if (!new RegExp(o).test(c))
                      throw new TypeError(
                        'Bvi console: ÐžÐ¿Ñ†Ð¸Ñ "'
                          .concat(i, '" Ð¿Ñ€ÐµÐ´Ð¾ÑÑ‚Ð°Ð²Ð»ÐµÐ½Ð½Ñ‹Ð¹ Ñ‚Ð¸Ð¿ "')
                          .concat(c, '", Ð¾Ð¶Ð¸Ð´Ð°ÐµÐ¼Ñ‹Ð¹ Ñ‚Ð¸Ð¿ "')
                          .concat(o, '".')
                      );
                  }),
                    Object.keys(i).forEach(function (t) {
                      ...
                      if (!new RegExp(n).test(r))
                        throw new TypeError(
                          'Bvi console: ÐžÐ¿Ñ†Ð¸Ñ "'
                            .concat(t, '" Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€ "')
                            .concat(
                              r,
                              '", Ð¾Ð¶Ð¸Ð´Ð°ÐµÐ¼Ñ‹Ð¹ Ð¿Ð°Ñ€Ð°Ð¼ÐµÑ‚Ñ€ "'
                            )
                            .concat(n, '".')
                        );
                    });
                    ...
                    i.forEach(function (e, t) {
                      ...
                      s(e, "div", "bvi-speech-text ".concat(n)),
                        e.insertAdjacentHTML(
                          "afterbegin",
                          '\n            <div class="bvi-speech-link">\n              <a href="#" class="bvi-link bvi-speech-play" title="Ð’Ð¾ÑÐ¿Ñ€Ð¾Ð¸Ð·Ð²ÐµÑÑ‚Ð¸">Ð’Ð¾ÑÐ¿Ñ€Ð¾Ð¸Ð·Ð²ÐµÑÑ‚Ð¸</a>\n              <a href="#" class="bvi-link bvi-speech-pause disabled" title="ÐŸÐ°ÑƒÐ·Ð°">ÐŸÐ°ÑƒÐ·Ð°</a>\n              <a href="#" class="bvi-link bvi-speech-resume disabled" title="ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ">ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ</a>\n              <a href="#" class="bvi-link bvi-speech-stop disabled" title="Ð¡Ñ‚Ð¾Ð¿">Ð¡Ñ‚Ð¾Ð¿</i></a>\n          </div>'
                        );
                    });
