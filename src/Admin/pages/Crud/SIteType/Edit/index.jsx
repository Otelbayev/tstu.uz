...
const Edit = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useEdit(
      ...
      `${import.meta.env.VITE_BASE_URL_API}/sitetype/updatesitetype`,
      `${import.meta.env.VITE_BASE_URL_API}/sitetype/updatesitetypetranslation`,
      [{ language_id }, { status_translation_id: status }],
      ["status_id"],
      `${import.meta.env.VITE_BASE_URL_API}/sitetype/createsitetypetranslation`,
      [{ language_id }, { site_type_id: id }],
      ["status_id"]
    );
  ...
  useEffect(() => {
    ...
    getDataById(
      value === "uz"
        ? `${import.meta.env.VITE_BASE_URL_API}/sitetype/getbyidsitetype/${id}`
        : `${
            import.meta.env.VITE_BASE_URL_API
          }/sitetype/getbyuzidsitetypetranslation/${id}?language_code=${value}`
    );
  }, [value, isCreate]);

  return (
    <Wrapper title="Edit Site Type">
