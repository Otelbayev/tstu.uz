...
const Create = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useCreate(
      ...
      "obj",
      { title: titleValue },
      `${import.meta.env.VITE_BASE_URL_API}/employment/createemployment`,
      `${import.meta.env.VITE_BASE_URL_API}/employment/createemploymenttranslation`,
      "employment_id",
      [{ language_id }]
    );

    res.statusCode === 200 && navigate(`/${i18n.language}/admin/employment`);
  };

  return (
    <Wrapper title="Create Employment">
