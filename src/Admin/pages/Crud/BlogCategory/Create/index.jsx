...
const Create = () => {
  ...
  const onHandleSubmit = async (e) => {
    ...
    const res = await useCreate(
      ...
      `${import.meta.env.VITE_BASE_URL_API}/blogcategorycontroller/createblogcategory`,
      `${import.meta.env.VITE_BASE_URL_API}/blogcategorycontroller/createblogcategorytranslation`,
      "blog_category_id",
      [{ language_id }]
    );
    res?.statusCode === 200 && navigate(`/${i18n.language}/admin/blogcategory`);
  };

  return (
    <Wrapper title="Create Blog Category">
